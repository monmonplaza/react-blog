  ...
  return (
    <header className='header px-4 py-3 border-b border-line bg-primary'>
      <div className='flex justify-end items-center gap-4 w-full relative'>
        ...
        <div>
          <button className='flex items-center gap-5' onClick={handleDropDown}>xxxx<LiaAngleDownSolid /></button>
            ...
            <h4 className='mb-1'>xxxx</h4>
            <p className='text-sm w-[150px] truncate'>xxxx</p>
